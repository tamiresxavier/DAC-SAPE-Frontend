            ...
            <div>
                <header className="App-header">
                    <fieldset>
                        ...
                        <br/>
                        <br/>
                        <SchedulingTable schedulings={this.state.scheduling} delete={this.delete}addIsPresent={this.addIsPresent} addParticipant={this.addParticipant}removeParticipant={this.removeParticipant}/>
                    </fieldset>
                    <br/>
